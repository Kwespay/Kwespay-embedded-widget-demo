  ...
  if (done) {
    return (
      <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center px-4">
        <div className="bg-[#0d0f1c] border border-white/10 rounded-2xl p-14 flex flex-col items-center gap-5 text-center max-w-sm w-full shadow-2xl">
          <div className="w-18 h-18 w-[72px] h-[72px] rounded-2xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center">
            <svg
          ...
          {txHash && (
            <div className="bg-white/5 rounded-xl px-4 py-3 w-full">
              ...
              <section className="space-y-4">
                ...
                {payMethod === "crypto" && (
                  <div className="space-y-4">
                    ...
                    <button
                      onClick={openKwesPayWidget}
                      className="w-full bg-[#3a5aeb] hover:bg-[#2f4bd6] text-white font-bold uppercase tracking-widest py-4 rounded-xl transition-all duration-200 shadow-lg shadow-[#3a5aeb]/25 hover:shadow-[#3a5aeb]/40 hover:-translate-y-0.5"
                    >
